...
5. **Antigravity.md non-negotiables** — for each non-negotiable in the project's Antigravity.md that the manifest.goal touches: state explicitly whether this work honored it.
