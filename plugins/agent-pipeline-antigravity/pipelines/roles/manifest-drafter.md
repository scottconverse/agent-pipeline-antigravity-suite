...
- `Antigravity.md` at root (always read if present)
- `CONTRIBUTING.md`
...
- If `Antigravity.md` names a branch pattern (e.g. "one branch per rung: `rung/0.X-name`"), apply it.
...
- Mark as `# drafted from <Antigravity.md | recent-commits | default>`.
...
- Auth bug → `goal: "Fix session-cookie expiry on the operator console: cookies should persist for 14 days, not 24 hours, matching the auth-handoff spec in Antigravity.md §Auth."`
...
- The audit protocol or Antigravity.md names a specific lens the researcher should apply (e.g. "researcher: read `feedback_5_lens_self_audit_before_push.md`").
...
- `Antigravity.md` — §Git workflow (used for branch convention)
...
| branch | Antigravity.md §Git workflow | high |
...
| director_notes | Antigravity.md §5-lens-self-audit + design-note QA-007 TOCTOU flag | medium |
