# Audit-Handoff Handbook — agent-pipeline-antigravity v0.3
...
- Per-agent wiring (Antigravity memory feedback file on the Antigravity side; the second AI's project-context or skill-registration file on the other side; or manual instructions for runtimes without a standing-instructions surface)

## When to use the audit-handoff discipline

Use it when:
- The project has two AI systems with separate context (e.g., Antigravity in Antigravity paired with a second AI in its own runtime).
...
|---|---|---|
| Example A | Antigravity | (a second AI) |
| Example B | (a second AI) | Antigravity |
| Your project | (your choice) | (your choice) |

The plugin itself runs in Antigravity. The second AI can be any tool whose project-context or standing-instructions surface lets you point it at the gate and protocol files. The discipline is the artifact set; the runtimes are interchangeable.
