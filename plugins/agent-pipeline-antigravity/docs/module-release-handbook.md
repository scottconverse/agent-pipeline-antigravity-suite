# Module Release Handbook — agent-pipeline-antigravity v0.2
...
1. Install agent-pipeline-antigravity plugin:
   ```bash
   # As a Antigravity plugin
   ...
   The plugin runs in Antigravity. Projects using a second AI for audit (v0.3 audit-handoff) wire that AI separately via its own standing-instructions surface.
