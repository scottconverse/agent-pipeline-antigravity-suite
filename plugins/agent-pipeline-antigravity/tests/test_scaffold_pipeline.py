...
test exercises the full LLM-driven path (model invokes Skill, Antigravity
...
correctly invokes the skill, that Antigravity CLI's Skill tool dispatch
works, or that the markdown step 3 instructions are followed. Those
remain covered by `test_skill_packaging.py`, the `Antigravity plugin list`
