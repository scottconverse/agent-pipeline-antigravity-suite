# CivicCast — Project Instructions for Antigravity (fixture)

> **Fixture replica.** The real CivicCast Antigravity.md is longer.
...
The manifest-drafter for `agent-pipeline-antigravity` reads these paths in this project:
