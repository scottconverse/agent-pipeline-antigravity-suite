...
A stripped-down replica of the CivicCast project structure. Used to exercise the manifest-drafter against a realistic spec / release-plan / scope-lock / design-note / Antigravity.md / HANDOFF.md layout without requiring access to the actual CivicCast repo.
...
2. The drafter writes `.agent-runs/<run-id>/manifest.yaml` with:
   ...
   - `definition_of_done` quoting the design note's exit-criteria + Antigravity.md CI-gate convention.
