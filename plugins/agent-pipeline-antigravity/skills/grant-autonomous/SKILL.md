...
You do not need a grant for anything. Just run `/agent-pipeline-antigravity:run "<task description>"`. Modal gates handle the human checkpoints; auto-promote handles the hands-off case.
